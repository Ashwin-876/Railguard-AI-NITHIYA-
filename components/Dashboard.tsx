    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <h3 className="text-slate-500 text-sm font-medium">Crowd Density</h3>
          <p className="text-2xl font-bold text-slate-900 mt-1">{STATION_DATA.crowdDensity}%</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <p className="text-2xl font-bold text-slate-900 mt-1">{STATION_DATA.activeIncidents}</p>
          <p className="text-xs text-slate-400 mt-4">2 Priority dispatched</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <h3 className="text-slate-500 text-sm font-medium">Safety Score</h3>
          <p className="text-2xl font-bold text-slate-900 mt-1">{STATION_DATA.safetyScore}/100</p>
          <p className="text-xs text-slate-400 mt-4">Based on AI protocols</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <h3 className="text-slate-500 text-sm font-medium">Trains in Transit</h3>
          <p className="text-2xl font-bold text-slate-900 mt-1">{MOCK_TRAINS.length}</p>
          <p className="text-xs text-slate-400 mt-4">Next: Rajdhani Exp (10m)</p>
        </div>
      </div>
              ...
              <div key={train.id} className="flex items-center justify-between p-4 rounded-xl border border-gray-50 hover:bg-gray-50 transition-colors">
                ...
                <div className="text-right">
                  <span className={`px-2 py-1 rounded text-xs font-bold ${
                    train.status === 'Delayed' ? 'bg-orange-100 text-orange-700' : 
